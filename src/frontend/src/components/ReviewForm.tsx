...
export default function ReviewForm({ review }: ReviewFormProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {showPreview ? (
        <div className="min-h-[400px] rounded-md border border-gray-200 bg-gray-50 bg-[url('/botanical-pattern.svg')] bg-[length:900px_900px] bg-repeat p-4">
          {body ? (
      ...
      <div className="flex items-center gap-3 border-t border-gray-200 pt-4">
        ...
        {isAdmin ? (
          <button
            ...
            disabled={saving || title.trim().length < 3 || body.trim().length < 10}
            className="rounded-md bg-orange-400 px-4 py-2 text-sm text-white hover:bg-orange-500 disabled:opacity-50"
          >
